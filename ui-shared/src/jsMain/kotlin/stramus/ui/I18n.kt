...
interface Strings {
    ...
    /** Settings → Theme: the Auto/Light/Dark switch that sits above the theme grid. */
    val themeMode: String

    /** The theme built out of the user's own accent colour, rather than one of ours. */
    val themeCustom: String

    /** The first accent swatch: whatever colour the chosen theme brought with it. */
    val accentAuto: String
    val accentIndigo: String
    val accentTeal: String
    val accentAmber: String

    /** The colour well the custom theme offers, and what mixing one is for. */
    val accentCustom: String
    val accentCustomHint: String

    /** Settings → Theme: how much room a card takes in the grid. */
    val cardStyle: String
    val cardStyleHint: String
    val cardStyleComfortable: String
    val cardStyleCompact: String

    /** Settings → Theme: how round cards, buttons and windows are drawn. */
    val cornerRadius: String
    val cornerRadiusHint: String
    val cornerSoft: String
    val cornerMedium: String
    val cornerSharp: String

    /** Settings → Theme: what stands behind the app — nothing, a gradient, or a picture. */
    val background: String
    val backgroundHint: String
    val backgroundNone: String
    val backgroundGradient: String
    val backgroundImage: String
    val backgroundPicture: String
    val backgroundPictureHint: String
    val backgroundPick: String
    val backgroundReplace: String
    val backgroundRemove: String

    /** The wallpaper is the one preference big enough for a browser to turn away. */
    val backgroundTooLarge: String
    val language: String
    ...
    val onboardingSectionsTitle: String
    val onboardingSectionsBody: String
...
private object EnStrings : Strings {
    ...
    override val accentAuto = "Theme's own"
    override val accentIndigo = "Indigo"
    override val accentTeal = "Teal"
    override val accentAmber = "Amber"
    override val accentCustom = "Custom color"
    override val accentCustomHint = "Mix the accent the custom theme is built on."
    override val cardStyle = "Card style"
    override val cardStyleHint = "How much room a card takes in the grid."
    override val cardStyleComfortable = "Comfortable"
    override val cardStyleCompact = "Compact"
    override val cornerRadius = "Corner radius"
    override val cornerRadiusHint = "How round cards, buttons and windows are."
    override val cornerSoft = "Soft"
    override val cornerMedium = "Medium"
    override val cornerSharp = "Sharp"
    override val background = "Background"
    override val backgroundHint = "What stands behind the app: nothing, a gradient, or a picture of your own."
    override val backgroundNone = "Solid"
    override val backgroundGradient = "Gradient"
    override val backgroundImage = "Image"
    override val backgroundPicture = "Picture"
    override val backgroundPictureHint = "Kept in this browser and scaled down first — it is never uploaded anywhere."
    override val backgroundPick = "Choose a picture…"
    override val backgroundReplace = "Choose another…"
    override val backgroundRemove = "Remove"
    override val backgroundTooLarge = "That picture is too large to keep in this browser — try a smaller one."
    ...
    override val onboardingOrganizeTitle = "Drag any tab straight into a collection"
    override val onboardingOrganizeBody = "That's the whole gesture: grab a tab from the sidebar and drop it on a collection to save it. Links, notes and files work the same way, from the + button."
    override val onboardingSectionsTitle = "Sections keep your collections tidy"
    override val onboardingSectionsBody = "The left sidebar groups your collections into sections you name yourself — work, personal, whatever makes sense. Everything you save lands exactly where you dropped it."
...
private object RuStrings : Strings {
    ...
    override val themeCustom = "Свой"
    override val accentAuto = "Цвет темы"
    override val accentIndigo = "Индиго"
    override val accentTeal = "Бирюзовый"
    override val accentAmber = "Янтарный"
    override val accentCustom = "Свой цвет"
    override val accentCustomHint = "Подберите акцент, на котором строится своя тема."
    override val cardStyle = "Стиль карточек"
    override val cardStyleHint = "Сколько места карточка занимает в сетке."
    override val cardStyleComfortable = "Просторно"
    override val cardStyleCompact = "Плотно"
    override val cornerRadius = "Скругление углов"
    override val cornerRadiusHint = "Насколько скруглены карточки, кнопки и окна."
    override val cornerSoft = "Мягкое"
    override val cornerMedium = "Среднее"
    override val cornerSharp = "Острое"
    override val background = "Фон"
    override val backgroundHint = "Что стоит за приложением: ничего, градиент или своя картинка."
    override val backgroundNone = "Сплошной"
    override val backgroundGradient = "Градиент"
    override val backgroundImage = "Картинка"
    override val backgroundPicture = "Картинка"
    override val backgroundPictureHint = "Хранится только в этом браузере и уменьшается перед сохранением — никуда не отправляется."
    override val backgroundPick = "Выбрать картинку…"
    override val backgroundReplace = "Выбрать другую…"
    override val backgroundRemove = "Убрать"
    override val backgroundTooLarge = "Картинка слишком велика для хранилища браузера — попробуйте поменьше."
    ...
    override val onboardingOrganizeTitle = "Перетащите вкладку прямо в коллекцию"
    override val onboardingOrganizeBody = "Это весь жест целиком: возьмите вкладку в боковой панели и бросьте её на коллекцию, чтобы сохранить. Ссылки, заметки и файлы добавляются так же — через кнопку +."
    override val onboardingSectionsTitle = "Разделы держат коллекции в порядке"
    override val onboardingSectionsBody = "Левая панель группирует ваши коллекции в разделы, которые вы называете сами — работа, личное, что угодно. Всё сохранённое оказывается именно там, куда вы его перетащили."
...
private object FrStrings : Strings {
    ...
    override val accentRose = "Rose"
    override val themeMode = "Mode"
    override val themeCustom = "Personnalisé"
    override val accentAuto = "Couleur du thème"
    override val accentIndigo = "Indigo"
    override val accentTeal = "Sarcelle"
    override val accentAmber = "Ambre"
    override val accentCustom = "Couleur personnalisée"
    override val accentCustomHint = "Composez l'accent sur lequel repose le thème personnalisé."
    override val cardStyle = "Style des cartes"
    override val cardStyleHint = "La place qu'une carte prend dans la grille."
    override val cardStyleComfortable = "Confortable"
    override val cardStyleCompact = "Compact"
    override val cornerRadius = "Arrondi des coins"
    override val cornerRadiusHint = "À quel point les cartes, boutons et fenêtres sont arrondis."
    override val cornerSoft = "Doux"
    override val cornerMedium = "Moyen"
    override val cornerSharp = "Net"
    override val background = "Arrière-plan"
    override val backgroundHint = "Ce qui se trouve derrière l'application : rien, un dégradé ou votre image."
    override val backgroundNone = "Uni"
    override val backgroundGradient = "Dégradé"
    override val backgroundImage = "Image"
    override val backgroundPicture = "Image"
    override val backgroundPictureHint = "Conservée dans ce navigateur, réduite au préalable — elle n'est envoyée nulle part."
    override val backgroundPick = "Choisir une image…"
    override val backgroundReplace = "En choisir une autre…"
    override val backgroundRemove = "Retirer"
    override val backgroundTooLarge = "Cette image est trop lourde pour le stockage du navigateur — essayez-en une plus petite."
    ...
    override val onboardingOrganizeTitle = "Glissez un onglet directement dans une collection"
    override val onboardingOrganizeBody = "C'est tout le geste : prenez un onglet dans la barre latérale et déposez-le sur une collection pour l'enregistrer. Les liens, notes et fichiers s'ajoutent de la même façon, depuis le bouton +."
    override val onboardingSectionsTitle = "Les sections gardent vos collections rangées"
    override val onboardingSectionsBody = "La barre latérale regroupe vos collections en sections que vous nommez vous-même — travail, personnel, comme vous voulez. Tout ce que vous enregistrez atterrit exactement là où vous l'avez déposé."
...
private object EsStrings : Strings {
    ...
    override val themeMode = "Modo"
    override val themeCustom = "Personalizado"
    override val accentAuto = "Color del tema"
    override val accentIndigo = "Índigo"
    override val accentTeal = "Verde azulado"
    override val accentAmber = "Ámbar"
    override val accentCustom = "Color propio"
    override val accentCustomHint = "Elige el acento sobre el que se construye el tema personalizado."
    override val cardStyle = "Estilo de tarjeta"
    override val cardStyleHint = "Cuánto espacio ocupa una tarjeta en la cuadrícula."
    override val cardStyleComfortable = "Cómodo"
    override val cardStyleCompact = "Compacto"
    override val cornerRadius = "Radio de esquinas"
    override val cornerRadiusHint = "Cuán redondeadas son las tarjetas, los botones y las ventanas."
    override val cornerSoft = "Suave"
    override val cornerMedium = "Medio"
    override val cornerSharp = "Recto"
    override val background = "Fondo"
    override val backgroundHint = "Lo que hay detrás de la aplicación: nada, un degradado o una imagen tuya."
    override val backgroundNone = "Sólido"
    override val backgroundGradient = "Degradado"
    override val backgroundImage = "Imagen"
    override val backgroundPicture = "Imagen"
    override val backgroundPictureHint = "Se guarda solo en este navegador y se reduce antes: nunca se sube a ningún sitio."
    override val backgroundPick = "Elegir una imagen…"
    override val backgroundReplace = "Elegir otra…"
    override val backgroundRemove = "Quitar"
    override val backgroundTooLarge = "Esa imagen es demasiado grande para el navegador: prueba con una más pequeña."
    ...
    override val onboardingOrganizeTitle = "Arrastra una pestaña directamente a una colección"
    override val onboardingOrganizeBody = "Ese es todo el gesto: toma una pestaña de la barra lateral y suéltala sobre una colección para guardarla. Los enlaces, notas y archivos se añaden igual, desde el botón +."
    override val onboardingSectionsTitle = "Las secciones mantienen tus colecciones ordenadas"
    override val onboardingSectionsBody = "La barra lateral agrupa tus colecciones en secciones que tú mismo nombras — trabajo, personal, lo que tenga sentido. Todo lo que guardas cae exactamente donde lo soltaste."
...
private object DeStrings : Strings {
    ...
    override val themeMode = "Modus"
    override val themeCustom = "Eigenes"
    override val accentAuto = "Farbe des Themes"
    override val accentIndigo = "Indigo"
    override val accentTeal = "Petrol"
    override val accentAmber = "Bernstein"
    override val accentCustom = "Eigene Farbe"
    override val accentCustomHint = "Mischen Sie den Akzent, auf dem das eigene Theme aufbaut."
    override val cardStyle = "Kartenstil"
    override val cardStyleHint = "Wie viel Platz eine Karte im Raster einnimmt."
    override val cardStyleComfortable = "Großzügig"
    override val cardStyleCompact = "Kompakt"
    override val cornerRadius = "Eckenradius"
    override val cornerRadiusHint = "Wie rund Karten, Schaltflächen und Fenster sind."
    override val cornerSoft = "Weich"
    override val cornerMedium = "Mittel"
    override val cornerSharp = "Scharf"
    override val background = "Hintergrund"
    override val backgroundHint = "Was hinter der App steht: nichts, ein Verlauf oder ein eigenes Bild."
    override val backgroundNone = "Einfarbig"
    override val backgroundGradient = "Verlauf"
    override val backgroundImage = "Bild"
    override val backgroundPicture = "Bild"
    override val backgroundPictureHint = "Bleibt in diesem Browser und wird vorher verkleinert — es wird nirgends hochgeladen."
    override val backgroundPick = "Bild auswählen…"
    override val backgroundReplace = "Anderes auswählen…"
    override val backgroundRemove = "Entfernen"
    override val backgroundTooLarge = "Dieses Bild ist zu groß für den Browser-Speicher — bitte ein kleineres wählen."
    ...
    override val onboardingOrganizeTitle = "Ziehe einen Tab direkt in eine Sammlung"
    override val onboardingOrganizeBody = "Das ist die ganze Geste: Nimm einen Tab aus der Seitenleiste und lass ihn auf einer Sammlung los, um ihn zu speichern. Links, Notizen und Dateien kommen genauso hinzu, über die Schaltfläche +."
    override val onboardingSectionsTitle = "Bereiche halten deine Sammlungen ordentlich"
    override val onboardingSectionsBody = "Die Seitenleiste gruppiert deine Sammlungen in Bereiche, die du selbst benennst — Arbeit, Privates, was auch immer passt. Alles, was du speicherst, landet genau dort, wo du es abgelegt hast."
...
private object PtBrStrings : Strings {
    ...
    override val themeMode = "Modo"
    override val themeCustom = "Personalizado"
    override val accentAuto = "Cor do tema"
    override val accentIndigo = "Índigo"
    override val accentTeal = "Azul-petróleo"
    override val accentAmber = "Âmbar"
    override val accentCustom = "Cor própria"
    override val accentCustomHint = "Escolha o destaque sobre o qual o tema personalizado é montado."
    override val cardStyle = "Estilo dos cartões"
    override val cardStyleHint = "Quanto espaço um cartão ocupa na grade."
    override val cardStyleComfortable = "Confortável"
    override val cardStyleCompact = "Compacto"
    override val cornerRadius = "Arredondamento"
    override val cornerRadiusHint = "O quanto cartões, botões e janelas são arredondados."
    override val cornerSoft = "Suave"
    override val cornerMedium = "Médio"
    override val cornerSharp = "Reto"
    override val background = "Fundo"
    override val backgroundHint = "O que fica atrás do aplicativo: nada, um gradiente ou uma imagem sua."
    override val backgroundNone = "Sólido"
    override val backgroundGradient = "Gradiente"
    override val backgroundImage = "Imagem"
    override val backgroundPicture = "Imagem"
    override val backgroundPictureHint = "Fica só neste navegador e é reduzida antes — nunca é enviada para lugar nenhum."
    override val backgroundPick = "Escolher uma imagem…"
    override val backgroundReplace = "Escolher outra…"
    override val backgroundRemove = "Remover"
    override val backgroundTooLarge = "Essa imagem é grande demais para o navegador — tente uma menor."
    override val language = "Idioma"
    ...
    override val onboardingOrganizeTitle = "Arraste uma aba direto para uma coleção"
    override val onboardingOrganizeBody = "É esse o gesto inteiro: pegue uma aba na barra lateral e solte sobre uma coleção para salvá-la. Links, notas e arquivos entram do mesmo jeito, pelo botão +."
    override val onboardingSectionsTitle = "Seções mantêm suas coleções organizadas"
    override val onboardingSectionsBody = "A barra lateral agrupa suas coleções em seções que você mesmo nomeia — trabalho, pessoal, o que fizer sentido. Tudo que você salva cai exatamente onde você soltou."
...
private object ZhCnStrings : Strings {
    ...
    override val themeMode = "模式"
    override val themeCustom = "自定义"
    override val accentAuto = "主题色"
    override val accentIndigo = "靛蓝"
    override val accentTeal = "青绿"
    override val accentAmber = "琥珀"
    override val accentCustom = "自定义颜色"
    override val accentCustomHint = "调出自定义主题所用的强调色。"
    override val cardStyle = "卡片样式"
    override val cardStyleHint = "卡片在网格中占多大空间。"
    override val cardStyleComfortable = "宽松"
    override val cardStyleCompact = "紧凑"
    override val cornerRadius = "圆角"
    override val cornerRadiusHint = "卡片、按钮和窗口的圆角程度。"
    override val cornerSoft = "圆润"
    override val cornerMedium = "适中"
    override val cornerSharp = "直角"
    override val background = "背景"
    override val backgroundHint = "应用背后是什么：纯色、渐变，或你自己的图片。"
    override val backgroundNone = "纯色"
    override val backgroundGradient = "渐变"
    override val backgroundImage = "图片"
    override val backgroundPicture = "图片"
    override val backgroundPictureHint = "先缩小再保存在本浏览器中，不会上传到任何地方。"
    override val backgroundPick = "选择图片…"
    override val backgroundReplace = "换一张…"
    override val backgroundRemove = "移除"
    override val backgroundTooLarge = "这张图片太大，浏览器存不下，请换一张小一些的。"
    ...
    override val onboardingOrganizeTitle = "把标签页直接拖进收藏夹"
    override val onboardingOrganizeBody = "整个操作就这么简单：从侧边栏抓住一个标签页，拖到收藏夹上松手即可保存。链接、笔记和文件也是同样的方式，通过 + 按钮添加。"
    override val onboardingSectionsTitle = "板块让收藏夹保持整洁"
    override val onboardingSectionsBody = "侧边栏把你的收藏夹归入你自己命名的板块——工作、个人，随你决定。保存的内容都会准确落在你拖放的位置。"
...
private object JaStrings : Strings {
    ...
    override val themeMode = "モード"
    override val themeCustom = "カスタム"
    override val accentAuto = "テーマの色"
    override val accentIndigo = "インディゴ"
    override val accentTeal = "ティール"
    override val accentAmber = "アンバー"
    override val accentCustom = "カスタムカラー"
    override val accentCustomHint = "カスタムテーマの基になるアクセント色を選びます。"
    override val cardStyle = "カードの表示"
    override val cardStyleHint = "グリッドの中でカードが取る余白の広さ。"
    override val cardStyleComfortable = "ゆったり"
    override val cardStyleCompact = "コンパクト"
    override val cornerRadius = "角の丸み"
    override val cornerRadiusHint = "カード・ボタン・ウィンドウの角の丸さ。"
    override val cornerSoft = "丸め"
    override val cornerMedium = "中"
    override val cornerSharp = "角ばり"
    override val background = "背景"
    override val backgroundHint = "アプリの背後に置くもの — 単色、グラデーション、または自分の画像。"
    override val backgroundNone = "単色"
    override val backgroundGradient = "グラデーション"
    override val backgroundImage = "画像"
    override val backgroundPicture = "画像"
    override val backgroundPictureHint = "縮小したうえでこのブラウザーにのみ保存します。どこにも送信されません。"
    override val backgroundPick = "画像を選ぶ…"
    override val backgroundReplace = "別の画像を選ぶ…"
    override val backgroundRemove = "削除"
    override val backgroundTooLarge = "この画像はブラウザーに保存するには大きすぎます。小さいものをお試しください。"
    ...
    override val onboardingOrganizeTitle = "タブをそのままコレクションへドラッグ"
    override val onboardingOrganizeBody = "操作はこれだけです。サイドバーのタブをつかんでコレクションにドロップすれば保存されます。リンクやメモ、ファイルも + ボタンから同じように追加できます。"
    override val onboardingSectionsTitle = "セクションでコレクションを整理"
    override val onboardingSectionsBody = "サイドバーは、自分で名付けたセクション（仕事、プライベートなど）にコレクションをまとめます。保存したものは、ドロップした場所にそのまま収まります。"
...
private object KoStrings : Strings {
    ...
    override val themeMode = "모드"
    override val themeCustom = "사용자 지정"
    override val accentAuto = "테마 색"
    override val accentIndigo = "인디고"
    override val accentTeal = "청록"
    override val accentAmber = "앰버"
    override val accentCustom = "사용자 색"
    override val accentCustomHint = "사용자 지정 테마의 강조색을 직접 고릅니다."
    override val cardStyle = "카드 스타일"
    override val cardStyleHint = "카드가 그리드에서 차지하는 공간."
    override val cardStyleComfortable = "여유롭게"
    override val cardStyleCompact = "촘촘하게"
    override val cornerRadius = "모서리 둥글기"
    override val cornerRadiusHint = "카드·버튼·창의 모서리가 얼마나 둥근지."
    override val cornerSoft = "둥글게"
    override val cornerMedium = "보통"
    override val cornerSharp = "각지게"
    override val background = "배경"
    override val backgroundHint = "앱 뒤에 놓일 것: 단색, 그러데이션, 또는 직접 고른 사진."
    override val backgroundNone = "단색"
    override val backgroundGradient = "그러데이션"
    override val backgroundImage = "이미지"
    override val backgroundPicture = "이미지"
    override val backgroundPictureHint = "크기를 줄여 이 브라우저에만 저장합니다. 어디에도 업로드되지 않습니다."
    override val backgroundPick = "이미지 선택…"
    override val backgroundReplace = "다른 이미지 선택…"
    override val backgroundRemove = "제거"
    override val backgroundTooLarge = "이 이미지는 브라우저에 저장하기에 너무 큽니다. 더 작은 것을 골라 보세요."
    ...
    override val onboardingOrganizeTitle = "탭을 컬렉션으로 바로 끌어다 놓으세요"
    override val onboardingOrganizeBody = "동작은 이게 전부입니다. 사이드바의 탭을 잡아 컬렉션 위에 놓으면 저장됩니다. 링크, 메모, 파일도 + 버튼으로 똑같이 추가할 수 있습니다."
    override val onboardingSectionsTitle = "섹션이 컬렉션을 깔끔하게 정리해줍니다"
    override val onboardingSectionsBody = "사이드바는 직접 이름 붙인 섹션—업무, 개인 등—으로 컬렉션을 묶어줍니다. 저장한 항목은 놓은 위치에 정확히 자리 잡습니다."
...
private object ItStrings : Strings {
    ...
    override val accentRose = "Rosa"
    override val themeMode = "Modalità"
    override val themeCustom = "Personalizzato"
    override val accentAuto = "Colore del tema"
    override val accentIndigo = "Indaco"
    override val accentTeal = "Petrolio"
    override val accentAmber = "Ambra"
    override val accentCustom = "Colore personalizzato"
    override val accentCustomHint = "Scegli l'accento su cui si basa il tema personalizzato."
    override val cardStyle = "Stile delle schede"
    override val cardStyleHint = "Quanto spazio occupa una scheda nella griglia."
    override val cardStyleComfortable = "Comodo"
    override val cardStyleCompact = "Compatto"
    override val cornerRadius = "Raggio degli angoli"
    override val cornerRadiusHint = "Quanto sono arrotondati schede, pulsanti e finestre."
    override val cornerSoft = "Morbido"
    override val cornerMedium = "Medio"
    override val cornerSharp = "Netto"
    override val background = "Sfondo"
    override val backgroundHint = "Cosa sta dietro l'app: niente, una sfumatura o una tua immagine."
    override val backgroundNone = "Tinta unita"
    override val backgroundGradient = "Sfumatura"
    override val backgroundImage = "Immagine"
    override val backgroundPicture = "Immagine"
    override val backgroundPictureHint = "Resta solo in questo browser e viene ridotta prima — non è caricata da nessuna parte."
    override val backgroundPick = "Scegli un'immagine…"
    override val backgroundReplace = "Scegline un'altra…"
    override val backgroundRemove = "Rimuovi"
    override val backgroundTooLarge = "Immagine troppo grande per lo spazio del browser: provane una più piccola."
    ...
    override val onboardingOrganizeTitle = "Trascina una scheda direttamente in una raccolta"
    override val onboardingOrganizeBody = "È tutto qui il gesto: prendi una scheda dalla barra laterale e rilasciala su una raccolta per salvarla. Link, note e file si aggiungono allo stesso modo, dal pulsante +."
    override val onboardingSectionsTitle = "Le sezioni tengono in ordine le tue raccolte"
    override val onboardingSectionsBody = "La barra laterale raggruppa le tue raccolte in sezioni che nomini tu — lavoro, personale, quel che ha senso. Tutto ciò che salvi finisce esattamente dove lo hai rilasciato."
...
private object TrStrings : Strings {
    ...
    override val themeMode = "Mod"
    override val themeCustom = "Özel"
    override val accentAuto = "Temanın rengi"
    override val accentIndigo = "Çivit"
    override val accentTeal = "Turkuaz"
    override val accentAmber = "Kehribar"
    override val accentCustom = "Özel renk"
    override val accentCustomHint = "Özel temanın kurulduğu vurgu rengini siz seçin."
    override val cardStyle = "Kart görünümü"
    override val cardStyleHint = "Bir kartın ızgarada ne kadar yer kapladığı."
    override val cardStyleComfortable = "Ferah"
    override val cardStyleCompact = "Sıkışık"
    override val cornerRadius = "Köşe yuvarlaklığı"
    override val cornerRadiusHint = "Kartların, düğmelerin ve pencerelerin ne kadar yuvarlak olduğu."
    override val cornerSoft = "Yumuşak"
    override val cornerMedium = "Orta"
    override val cornerSharp = "Keskin"
    override val background = "Arka plan"
    override val backgroundHint = "Uygulamanın arkasında ne duracak: düz renk, geçiş ya da kendi görseliniz."
    override val backgroundNone = "Düz renk"
    override val backgroundGradient = "Renk geçişi"
    override val backgroundImage = "Görsel"
    override val backgroundPicture = "Görsel"
    override val backgroundPictureHint = "Küçültülüp yalnızca bu tarayıcıda saklanır; hiçbir yere yüklenmez."
    override val backgroundPick = "Görsel seç…"
    override val backgroundReplace = "Başka bir görsel seç…"
    override val backgroundRemove = "Kaldır"
    override val backgroundTooLarge = "Bu görsel tarayıcıda saklanamayacak kadar büyük; daha küçüğünü deneyin."
    ...
    override val onboardingOrganizeTitle = "Bir sekmeyi doğrudan koleksiyona sürükle"
    override val onboardingOrganizeBody = "Yapman gereken tek şey bu: kenar çubuğundan bir sekme al ve kaydetmek için bir koleksiyonun üzerine bırak. Bağlantılar, notlar ve dosyalar da + düğmesiyle aynı şekilde eklenir."
    override val onboardingSectionsTitle = "Bölümler koleksiyonlarını düzenli tutar"
    override val onboardingSectionsBody = "Kenar çubuğu, koleksiyonlarını kendi adlandırdığın bölümlerde toplar — iş, kişisel, ne uygunsa. Kaydettiğin her şey tam bıraktığın yere gider."
