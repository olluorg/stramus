...
> Paste everything below the line into the Web Store's "Detailed description" field for the Italian
> listing. The name and the short description come from `_locales/it/messages.json` in the uploaded ZIP,
> not from here.
>
