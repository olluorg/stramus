...
> Paste everything below the line into the Web Store's "Detailed description" field for the Turkish
> listing. The name and the short description come from `_locales/tr/messages.json` in the uploaded ZIP,
> not from here.
>
